...
if ($logged_in && isset($_SESSION['user_id'])) {
    ...
    $stmt = $conn->prepare("SELECT 1 FROM favorites WHERE user_id = ? AND destination_id = 8");
    ...
    <body>
        ...
        <div class="dest-hero-image">
            ...
            <div class="dest-hero-overlay">
                ...
                <h1 class="country-name">Peru <?php if ($logged_in): ?><span class="favorite-star <?php echo $is_favorite ? 'filled' : 'empty'; ?>" data-destination-id="8" title="Přidat/Odebrat z oblíbených"><?php echo $is_favorite ? '★' : '☆'; ?></span><?php endif; ?></h1>
            </div>
        </div>
        ...
        <main>
            <section class="destination-detail">
                <div class="basic-info">
                    ...
                    <ul>
                        <li><strong>Rozloha:</strong> 1 285 216 km²</li>
                        <li><strong>Počet obyvatel:</strong> 33 milionů</li>
                        <li><strong>Hlavní město:</strong> Lima</li>
                        <li><strong>Oficiální jazyk:</strong> Španělština, Kečuánština</li>
                        <li><strong>Měna:</strong> Peruánský sol (PEN)</li>
                    </ul>
                </div>
                ...
                <div class="description">
                    ...
                    <p>
                        Peru je zemí záhadných civilizací, úchvatné přírody a výjimečné gastronomie. Machu
                        Picchu, citadela Inků ukrytá v andských vrcholcích, patří k nejvýznamnějším
                        archeologickým lokalitám světa. Amazonský deštný prales na východě kontrastuje
                        s pouštním pobřežím a zasněženými Andami. Lima patří ke gastronomickým metropolím
                        světa a místní kuchyně je zcela unikátní.
                    </p>
                </div>
                ...
                <div class="highlights">
                    ...
                    <ul>
                        <li>Machu Picchu – Inká citadela UNESCO</li>
                        <li>Cuzco – historické centrum Inků</li>
                        <li>Jezero Titicaca – nejvýše položené splavné jezero</li>
                        <li>Nazca – záhadné geoglyfy v poušti</li>
                        <li>Amazonský prales – Puerto Maldonado</li>
                    </ul>
                </div>

                <div class="activities">
                    <h2>Co dělat v Peru</h2>
                    <ul>
                        <li>Treking po Inca Trail na Machu Picchu</li>
                        <li>Přeplout Titicacu k ostrovům Uros</li>
                        <li>Ochutnat ceviche a pisco sour v Limě</li>
                        <li>Přelet nad Nazca Lines malým letadlem</li>
                        <li>Návštěva trhu v Pisacu na Sacred Valley</li>
                    </ul>
                </div>
            </section>
