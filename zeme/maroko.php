...
if ($logged_in && isset($_SESSION['user_id'])) {
    ...
    $stmt = $conn->prepare("SELECT 1 FROM favorites WHERE user_id = ? AND destination_id = 9");
...
<html lang="cs" dir="ltr">
    ...
    <body>
        ...
        <div class="dest-hero-image">
            <img src="../img/maroko.jpg" alt="Maroko">
            <div class="dest-hero-overlay">
                <a href="../pages/destinace.php" class="hero-back-btn"><i class="fa-solid fa-arrow-left"></i> Zpět</a>
                <h1 class="country-name">Maroko <?php if ($logged_in): ?><span class="favorite-star <?php echo $is_favorite ? 'filled' : 'empty'; ?>" data-destination-id="9" title="Přidat/Odebrat z oblíbených"><?php echo $is_favorite ? '★' : '☆'; ?></span><?php endif; ?></h1>
            </div>
        </div>
        ...
        <main>
            <section class="destination-detail">
                <div class="basic-info">
                    ...
                    <ul>
                        <li><strong>Rozloha:</strong> 710 850 km²</li>
                        <li><strong>Počet obyvatel:</strong> 37 milionů</li>
                        <li><strong>Hlavní město:</strong> Rabat</li>
                        <li><strong>Oficiální jazyk:</strong> Arabština, Berberština</li>
                ...
                <div class="description">
                    ...
                    <p>
                        Maroko je zemí překvapivých kontrastů — od zlatých dun Sahary po zasněžené vrcholy
                        Atlasu, od rušných středověkých medín po moderní pobřežní letoviska. Marrákeš omámí
                        vůněmi koření na náměstí Djemaa el-Fna, Fés okouzlí labyrintem uliček historické
                        medíny UNESCO. Berberská kultura, arabský vliv a atlantické pobřeží tvoří jedinečnou
                        mozaiku zážitků.
                    </p>
                </div>
                ...
                <div class="highlights">
                    ...
                    <ul>
                        <li>Marrákeš – medína, paláce, zahrada Majorelle</li>
                        <li>Fés – nejstarší UNESCO medína na světě</li>
                        <li>Sahara u Merzouga – přenocování v poušti</li>
                        <li>Šéfšáuen – modrá horská vesnička</li>
                        <li>Essaouira – pobřežní město a pevnost</li>
                    </ul>
                </div>

                <div class="activities">
                    <h2>Co dělat v Maroku</h2>
                    <ul>
                        <li>Přenocovat pod hvězdami v saharských dunách</li>
                        <li>Projet se velbloudem pouští Erg Chebbi</li>
                        <li>Navštívit tradiční hammam (marocká lázeň)</li>
                        <li>Smlouvat na souků o koření a keramiku</li>
                        <li>Surfovat na atlantickém pobřeží v Agadiru</li>
                    </ul>
                </div>
            </section>
