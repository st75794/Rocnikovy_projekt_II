...
<html lang="en" dir="ltr">
    ...
    <body>
        ...
        <div class="dest-hero-image">
            <img src="../img/slovinsko.jpg" alt="Slovinsko">
            <div class="dest-hero-overlay">
                <a href="../pages/destinace.php" class="hero-back-btn"><i class="fa-solid fa-arrow-left"></i> Zpět</a>
                <h1 class="country-name">Slovinsko <?php if ($logged_in): ?><span class="favorite-star <?php echo $is_favorite ? 'filled' : 'empty'; ?>" data-destination-id="3" title="Přidat/Odebrat z oblíbených"><?php echo $is_favorite ? '★' : '☆'; ?></span><?php endif; ?></h1>
            </div>
        </div>
