...
if ($logged_in && isset($_SESSION['user_id'])) {
    ...
    $stmt = $conn->prepare("SELECT 1 FROM favorites WHERE user_id = ? AND destination_id = 6");
...
<html lang="cs" dir="ltr">
    ...
    <body>
        ...
        <div class="dest-hero-image">
            <img src="../img/thajsko.jpg" alt="Thajsko">
            <div class="dest-hero-overlay">
                <a href="../pages/destinace.php" class="hero-back-btn"><i class="fa-solid fa-arrow-left"></i> Zpět</a>
                <h1 class="country-name">Thajsko <?php if ($logged_in): ?><span class="favorite-star <?php echo $is_favorite ? 'filled' : 'empty'; ?>" data-destination-id="6" title="Přidat/Odebrat z oblíbených"><?php echo $is_favorite ? '★' : '☆'; ?></span><?php endif; ?></h1>
            </div>
        </div>
        ...
        <main>
            <section class="destination-detail">
                <div class="basic-info">
                    ...
                    <ul>
                        <li><strong>Rozloha:</strong> 513 120 km²</li>
                        <li><strong>Počet obyvatel:</strong> 70 milionů</li>
                        <li><strong>Hlavní město:</strong> Bangkok</li>
                        <li><strong>Oficiální jazyk:</strong> Thajština</li>
                        <li><strong>Měna:</strong> Thajský baht (THB)</li>
                    </ul>
                </div>
                ...
                <div class="description">
                    ...
                    <p>
                        Thajsko, „Země úsměvů", okouzlí zlatými chrámy, tropickými plážemi a nezapomenutelnou
                        kuchyní. Bangkok překvapí rušnými trhy a okázalými paláci, zatímco sever kolem Chiang
                        Mai nabízí klid lesů a tradici. Ostrovy jako Phuket, Koh Samui nebo Koh Tao lákají
                        potápěče i milovníky odpočinku. Thajsko je ideální kombinací kultury, přírody a pohody.
                    </p>
                </div>
                ...
                <div class="highlights">
                    ...
                    <ul>
                        <li>Bangkok – Velký palác, Wat Pho, Khao San Road</li>
                        <li>Chiang Mai – chrámy, sloní safari</li>
                        <li>Phuket – pláže Patong, Kata, Karon</li>
                        <li>Koh Tao – potápění a šnorchlování</li>
                        <li>Ayutthaya – historické ruiny UNESCO</li>
                    </ul>
                </div>

                <div class="activities">
                    <h2>Co dělat v Thajsku</h2>
                    <ul>
                        <li>Navštívit zlaté buddhistické chrámy (waty)</li>
                        <li>Ochutnat thajskou kuchyni na nočním tržišti</li>
                        <li>Potápění a šnorchlování v průzračném moři</li>
                        <li>Thai masáž – tradiční thajská relaxace</li>
                        <li>Zažít Festival světel Loy Krathong</li>
                    </ul>
                </div>
            </section>
