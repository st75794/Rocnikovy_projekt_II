    ...
    <body>
        ...
        <div class="dest-hero-image">
            ...
            <div class="dest-hero-overlay">
                ...
                <h1 class="country-name">Island <?php if ($logged_in): ?><span class="favorite-star <?php echo $is_favorite ? 'filled' : 'empty'; ?>" data-destination-id="1" title="Přidat/Odebrat z oblíbených"><?php echo $is_favorite ? '★' : '☆'; ?></span><?php endif; ?></h1>
            </div>
        </div>
