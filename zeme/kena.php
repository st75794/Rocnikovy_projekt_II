...
if ($logged_in && isset($_SESSION['user_id'])) {
    ...
    $stmt = $conn->prepare("SELECT 1 FROM favorites WHERE user_id = ? AND destination_id = 10");
...
<html lang="cs" dir="ltr">
    ...
    <body>
        ...
        <div class="dest-hero-image">
            <img src="../img/kena.jpg" alt="Keňa">
            <div class="dest-hero-overlay">
                <a href="../pages/destinace.php" class="hero-back-btn"><i class="fa-solid fa-arrow-left"></i> Zpět</a>
                <h1 class="country-name">Keňa <?php if ($logged_in): ?><span class="favorite-star <?php echo $is_favorite ? 'filled' : 'empty'; ?>" data-destination-id="10" title="Přidat/Odebrat z oblíbených"><?php echo $is_favorite ? '★' : '☆'; ?></span><?php endif; ?></h1>
            </div>
        </div>
        ...
        <main>
            <section class="destination-detail">
                <div class="basic-info">
                    ...
                    <ul>
                        <li><strong>Rozloha:</strong> 582 650 km²</li>
                        <li><strong>Počet obyvatel:</strong> 55 milionů</li>
                        <li><strong>Hlavní město:</strong> Nairobi</li>
                        <li><strong>Oficiální jazyk:</strong> Svahilština, Angličtina</li>
                        <li><strong>Měna:</strong> Keňský šilink (KES)</li>
                    </ul>
                </div>
                ...
                <div class="description">
                    ...
                    <p>
                        Keňa je synonymem pro africkou divočinu v tom nejúchvatnějším vydání. Safari v Maasai
                        Mara, kde lze sledovat Velkou migraci milionů pakoňů, patří k nejsilnějším zážitkům
                        na světě. Kilimandžáro vrhá stín na savany, zatímco na pobřeží Indického oceánu
                        v Mombase se bělají korálové pláže. Keňa je zemí, kde Afrika mluví plnou silou svého
                        hlasu.
                    </p>
                </div>
                ...
                <div class="highlights">
                    ...
                    <ul>
                        <li>Maasai Mara – Velká migrace, Velká pětka</li>
                        <li>Amboseli – sloni na pozadí Kilimandžára</li>
                        <li>Mombasa – pobřeží Indického oceánu</li>
                        <li>Nairobi – národní park přímo ve městě</li>
                        <li>Jezero Nakuru – plameňáci a nosorožci</li>
                    </ul>
                </div>

                <div class="activities">
                    <h2>Co dělat v Keňi</h2>
                    <ul>
                        <li>Safari v Maasai Mara a sledování migrace</li>
                        <li>Výstup na horu Kenya (druhá nejvyšší hora Afriky)</li>
                        <li>Potápění a šnorchlování u Mombasského riffu</li>
                        <li>Návštěva maasaiské vesnice a setkání s místními</li>
                        <li>Balonový let nad savanami při úsvitu</li>
                    </ul>
                </div>
            </section>
