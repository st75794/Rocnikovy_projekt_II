...
if ($logged_in && isset($_SESSION['user_id'])) {
    ...
    $stmt = $conn->prepare("SELECT 1 FROM favorites WHERE user_id = ? AND destination_id = 7");
    ...
    <body>
        ...
        <div class="dest-hero-image">
            ...
            <div class="dest-hero-overlay">
                ...
                <h1 class="country-name">Kanada <?php if ($logged_in): ?><span class="favorite-star <?php echo $is_favorite ? 'filled' : 'empty'; ?>" data-destination-id="7" title="Přidat/Odebrat z oblíbených"><?php echo $is_favorite ? '★' : '☆'; ?></span><?php endif; ?></h1>
            </div>
        </div>
        ...
        <main>
            <section class="destination-detail">
                <div class="basic-info">
                    ...
                    <ul>
                        <li><strong>Rozloha:</strong> 9 984 670 km²</li>
                        <li><strong>Počet obyvatel:</strong> 38 milionů</li>
                        <li><strong>Hlavní město:</strong> Ottawa</li>
                        <li><strong>Oficiální jazyk:</strong> Angličtina, Francouzština</li>
                        <li><strong>Měna:</strong> Kanadský dolar (CAD)</li>
                    </ul>
                </div>
                ...
                <div class="description">
                    ...
                    <p>
                        Kanada, druhá největší země světa, ohromí neposkvrněnou přírodou, přátelskými lidmi
                        a kosmopolitními městy. Národní parky jako Banff a Jasper nabízejí tyrkysová jezera,
                        zasněžené vrcholy a divokou zvěř. Vancouver a Toronto patří k nejkvalitnějším městům
                        pro život, zatímco Quebec City okouzlí evropskou atmosférou. Kanada je rájem pro
                        dobrodruhy i milovníky kultury.
                    </p>
                </div>
                ...
                <div class="highlights">
                    ...
                    <ul>
                        <li>Národní park Banff – jezero Louise, ledovce</li>
                        <li>Niagarské vodopády</li>
                        <li>Vancouver – Stanley Park, Grouse Mountain</li>
                        <li>Quebec City – historické opevnění UNESCO</li>
                        <li>Tofino – surfování a velryby</li>
                    </ul>
                </div>

                <div class="activities">
                    <h2>Co dělat v Kanadě</h2>
                    <ul>
                        <li>Lyžování v Whistleru nebo Banffu</li>
                        <li>Pozorování polární záře na Yukonu</li>
                        <li>Kajak a rafting v divokých řekách</li>
                        <li>Sledování ledních medvědů v Churchillu</li>
                        <li>Výlet podél trasy Icefields Parkway</li>
                    </ul>
                </div>
            </section>
