...
if ($logged_in && isset($_SESSION['user_id'])) {
    ...
    $stmt = $conn->prepare("SELECT 1 FROM favorites WHERE user_id = ? AND destination_id = 5");
...
<html lang="cs" dir="ltr">
    ...
    <body>
        ...
        <div class="dest-hero-image">
            <img src="../img/japonsko.jpg" alt="Japonsko">
            <div class="dest-hero-overlay">
                <a href="../pages/destinace.php" class="hero-back-btn"><i class="fa-solid fa-arrow-left"></i> Zpět</a>
                <h1 class="country-name">Japonsko <?php if ($logged_in): ?><span class="favorite-star <?php echo $is_favorite ? 'filled' : 'empty'; ?>" data-destination-id="5" title="Přidat/Odebrat z oblíbených"><?php echo $is_favorite ? '★' : '☆'; ?></span><?php endif; ?></h1>
            </div>
        </div>
        ...
        <main>
            <section class="destination-detail">
                <div class="basic-info">
                    ...
                    <ul>
                        <li><strong>Rozloha:</strong> 377 975 km²</li>
                        <li><strong>Počet obyvatel:</strong> 125 milionů</li>
                        <li><strong>Hlavní město:</strong> Tokio</li>
                        <li><strong>Oficiální jazyk:</strong> Japonština</li>
                        <li><strong>Měna:</strong> Japonský jen (JPY)</li>
                    </ul>
                </div>
                ...
                <div class="description">
                    ...
                    <p>
                        Japonsko je fascinující zemí, kde se setkává tisíciletá tradice s moderní technologií.
                        Procházejte se mezi rozkvetlými třešněmi v Kjótu, obdivujte ikonickou horu Fuji nebo
                        se ponořte do pulzujícího velkoměsta Tokia. Ochutnejte pravé sushi, ramen a wagashi,
                        zažijte klid zenových zahrad a tajemství šintoistických chrámů. Japonsko nabízí
                        nezapomenutelné zážitky pro každého cestovatele.
                    </p>
                </div>
                ...
                <div class="highlights">
                    ...
                    <ul>
                        <li>Tokio – Shibuya, Akihabara, Senso-ji</li>
                        <li>Kjóto – Fushimi Inari, Zlatý pavilon</li>
                        <li>Hora Fuji a oblast Hakone</li>
                        <li>Hirošima a Ostrov Mijadžima</li>
                        <li>Osaka – Dotonbori, hrad Osaka</li>
                    </ul>
                </div>

                <div class="activities">
                    <h2>Co dělat v Japonsku</h2>
                    <ul>
                        <li>Zažít hanami – pozorování třešňových květů</li>
                        <li>Navštívit tradiční onsen (horké prameny)</li>
                        <li>Vyzkoušet japonskou kuchyni na tržnici Tsukiji</li>
                        <li>Projet se vlakem Shinkansen (bullet train)</li>
                        <li>Zúčastnit se čajového obřadu</li>
                    </ul>
                </div>
            </section>
